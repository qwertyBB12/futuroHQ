...
export default defineType({
  name: 'siteSettings_arkah',
  title: 'Arkah Site Settings',
  type: 'document',
  description: 'Global configuration powering arkah.com defaults, metadata, and shared UI copy',
  fields: [
    defineField({
      name: 'siteTitle',
      title: 'Site Title',
    ...
    defineField({
      ...
      title: 'Social Links',
      type: 'array',
      description: 'Structured list of Arkah social channels',
      of: [
        defineField({
          name: 'socialLink',
          title: 'Social Link',
  ...
  preview: {
    ...
    prepare({ title, subtitle, media }) {
      return {
        title: title || 'Arkah Site Settings',
