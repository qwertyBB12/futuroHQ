...
export default defineType({
  name: 'siteSettings_benext',
  title: 'BeNeXT Site Settings',
  type: 'document',
  description: 'Global configuration powering benextglobal.com defaults, metadata, and shared UI copy',
  fields: [
    defineField({
      name: 'siteTitle',
      title: 'Site Title',
    ...
    defineField({
      ...
      title: 'Social Links',
      type: 'array',
      description: 'Structured list of BeNeXT social channels',
      of: [
        defineField({
          name: 'socialLink',
          title: 'Social Link',
  ...
  preview: {
    ...
    prepare({ title, subtitle, media }) {
      return {
        title: title || 'BeNeXT Site Settings',
