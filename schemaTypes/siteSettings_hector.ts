...
export default defineType({
  name: 'siteSettings_hector',
  title: 'Hector Site Settings',
  type: 'document',
  description: 'Global configuration powering hectorhlopez.com defaults, metadata, and shared UI copy',
  fields: [
    defineField({
      name: 'siteTitle',
      title: 'Site Title',
    ...
    defineField({
      ...
      title: 'Social Links',
      type: 'array',
      description: 'Structured list of Hector social channels',
      of: [
        defineField({
          name: 'socialLink',
          title: 'Social Link',
  ...
  preview: {
    ...
    prepare({ title, subtitle, media }) {
      return {
        title: title || 'Hector Site Settings',
