...
export default defineType({
  name: 'siteSettings_mitikah',
  title: 'Mitikah Site Settings',
  type: 'document',
  description: 'Global configuration powering mitikah.com defaults, metadata, and shared UI copy',
  fields: [
    defineField({
      name: 'siteTitle',
      title: 'Site Title',
    ...
    defineField({
      ...
      title: 'Social Links',
      type: 'array',
      description: 'Structured list of Mitikah social channels',
      of: [
        defineField({
          name: 'socialLink',
          title: 'Social Link',
  ...
  preview: {
    ...
    prepare({ title, subtitle, media }) {
      return {
        title: title || 'Mitikah Site Settings',
