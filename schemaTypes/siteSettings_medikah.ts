...
export default defineType({
  name: 'siteSettings_medikah',
  title: 'Medikah Site Settings',
  type: 'document',
  description: 'Global configuration powering medikah.com defaults, metadata, and shared UI copy',
  fields: [
    defineField({
      name: 'siteTitle',
      title: 'Site Title',
    ...
    defineField({
      ...
      title: 'Social Links',
      type: 'array',
      description: 'Structured list of Medikah social channels',
      of: [
        defineField({
          name: 'socialLink',
          title: 'Social Link',
  ...
  preview: {
    ...
    prepare({ title, subtitle, media }) {
      return {
        title: title || 'Medikah Site Settings',
